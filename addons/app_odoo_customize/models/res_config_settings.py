...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char('System Name', help="Setup System Name,which replace xxxx")
    ...
    app_show_share = fields.Boolean('Show Share Dashboard', help="Uncheck to hide the Share Dashboard")
    app_show_poweredby = fields.Boolean('Show Powered by Arbepos', help="Uncheck to hide the Powered by text")
    ...
    module_odoo_referral = fields.Boolean('Show Referral', help="Uncheck to remove the Referral")
    ...
    def get_values(self):
        ...
        app_system_name = ir_config.get_param('app_system_name', default='Arbepos')
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.arbepos.com/documentation/user/12.0/en/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.arbepos.com/documentation/12.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.arbepos.com/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.arbepos.com/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.arbepos.com')
        app_ribbon_name = ir_config.get_param('app_ribbon_name', default='*arbepos.com')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.arbepos.com/documentation/user/12.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.arbepos.com/documentation/12.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.arbepos.com/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.arbepos.com/my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.arbepos.com")
        ir_config.set_param("app_ribbon_name", self.app_ribbon_name or "*Arbepos.com")
